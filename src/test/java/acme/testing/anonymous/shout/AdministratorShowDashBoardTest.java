...
public class AdministratorShowDashBoardTest extends AcmePlannerTest{
	...
	public void positiveDashBoardShow(final String nPrivateTasks, final String nPublicTask, 
		...
		final String ratioShoutsFlaggedTrue,final String ratioShoutsBudgetZero,
		final String averageSheetGroupByCurrency1,final String averageSheetGroupByCurrency2,final String averageSheetGroupByCurrency3,
		final String deviationSheetGroupByCurrency1,final String deviationSheetGroupByCurrency2,final String deviationSheetGroupByCurrency3) {
		...
		final String xpath_tabla14 = "//table[@id='ratio']//tr[8]/td";
		...
		assert super.locateOne(By.xpath(xpath_tabla8)).getText().equals(ratioShoutsBudgetZero);
		assert super.locateOne(By.xpath(xpath_tabla9)).getText().equals(averageSheetGroupByCurrency1);
		assert super.locateOne(By.xpath(xpath_tabla10)).getText().equals(averageSheetGroupByCurrency2);
		assert super.locateOne(By.xpath(xpath_tabla11)).getText().equals(averageSheetGroupByCurrency3);
		...
		assert super.locateOne(By.xpath(xpath_tabla14)).getText().equals(deviationSheetGroupByCurrency3);
