...
public class AnonymousListTest	extends AcmePlannerTest {
	...
	public void listAll(final int recordIndex,final String moment,final String author,final String text,final String info,
		final String infoDate, final String infoMoneyCurrency, final String infoMoneyAmount,final String infoFlag) {		
		...
		super.checkColumnHasValue(recordIndex, 5, infoMoneyCurrency);
		super.checkColumnHasValue(recordIndex, 6, infoMoneyAmount);
		super.checkColumnHasValue(recordIndex, 7, infoFlag);
